...
const Page_iPhone_11_Pro___X___6  = ({navigation}) => {
	useEffect(() => {
	}, []);
	return (
	...
	<ScrollView bounces={false} showsVerticalScrollIndicator={false} style={{height: Dimensions.get("window").height}}>
		<View style = {noneModeStyles._page5}    >
			...
			<Text style = {noneModeStyles._Buy_Pet_Food}   >
				Buy Pet Food
			</Text>
			<Text style = {noneModeStyles._Need_to_buy_food_for_cat}   >
				Need to buy food for cat
			</Text>
...
export default Page_iPhone_11_Pro___X___6
